...
namespace StupidTemplate.Menu
{
    ...
    internal class JoinPatch : MonoBehaviour
    {
        private static void Prefix(Player newPlayer)
        {
            ...
            {
                NotifiLib.SendNotification("<color=grey>[</color><color=green>+</color><color=grey>]</color> " + newPlayer.NickName);
    ...
    internal class LeavePatch : MonoBehaviour
    {
        private static void Prefix(Player otherPlayer)
        {
            ...
            {
                NotifiLib.SendNotification("<color=grey>[</color><color=red>-</color><color=grey>]</color> " + otherPlayer.NickName);
                a = otherPlayer;
            }
        }
